...
def main_apv():
    ...
    r1=requests.get("https://github.com/").text
    ...
    if key1 in r1:
        ...
        print ("         ༄ahsam᭄•───────────────────────────────────────•༄joiya᭄")
        print ("             \033[1;94m APROVAL  Free Auh")     
...
logo="""
             \033[1;93m_______   _______   __    __ 
             \033[1;95m|       \ |       \ |  \  |  \
             \033[1;93m| (       )(  ____ )  (  ___  )|\     /||\     /|
             \033[1;95m| | () () || (    )|  | (   ) || )   ( || )   ( |
             \033[1;93m| | || || || (____)|  | (___) || |   | || (___) |
             \033[1;95m| | |(_)| ||     __)  |  ___  || |   | ||  ___  |
             \033[1;93m| | |   | || (\ (     | (   ) || |   | || (   ) |
             \033[1;95m| | )   ( || ) \ \__  | )   ( || (___) || )   ( |
             \033[1;93m |/     \||/   \__/  |/     \|(_______)|/     \|
        \033[1;92m༄AUH᭄•───────────────────────────────────────•༄BRAND᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             ...
             \033[1;93m▇▇➣    \033[1;94m  APRVAL free     \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄Ahsam᭄•───────────────────────────────────────•༄ul Haq᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/Auh-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : ahsam-brand")
			print ('\033[1;92m༄ahsam᭄•───────────────────────────────────────•༄king᭄')
			key = input(" [*] Choose : ")
			print ('༄ahsam᭄•───────────────────────────────────────•༄brand᭄')
